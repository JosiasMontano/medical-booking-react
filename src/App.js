import React, { useState } from 'react';  // Importa React y useState (en lugar de usar React desde CDN)
import './App.css';  // Importa tu CSS migrado

// Datos hardcodeados (puedes moverlos a un archivo separado si crece, ej. src/data.js)
const doctors = [
...
function App() {  // Componente principal (cambié el nombre de MedicalBookingApp a App para que coincida con CRA)
    const [selectedDoctor, setSelectedDoctor] = useState(null);  // Cambié React.useState a useState
...
export default App;  // Exporta el componente para que CRA lo renderice